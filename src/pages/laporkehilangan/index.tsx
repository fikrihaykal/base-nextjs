...
import { DropdownItem, DropdownKehilangan, DropdownLokasi } from "@/data/dummy";
import DropdownInput from "@/components/molecules/DropdownInput";
import InputAreaFormik from "@/components/molecules/InputArea";

const LaporKehilangan = () => {
  ...
  return (
    <>
      <ModalContextProvider>
        <PageTransition pageTitle="Laporan Kehilangan">
          <PageRow>
            <PageCol>
              <FormKehilangan />
            </PageCol>
...
export default LaporKehilangan;
