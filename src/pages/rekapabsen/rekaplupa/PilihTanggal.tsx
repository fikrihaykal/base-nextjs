...
export const PilihTanggal = () => {
  ...
  useEffect(() => {
    setFieldValue("tanggalCuti", startDate);
  }, [startDate]);
      ...
      <Flex flex="1" minW="240px">
          ...
          >
            <DatePicker
              ...
              onChange={(date: Date) => {
                setStartDate(date);
                setFieldValue("tanggalPerbaiki", date);
              }}
    ...
    return (
      ...
      >
        ...
        >
          <Flex>
            {/* {label}{" "} */}
            <Text fontWeight="500">Pilih Tanggal</Text>
        ...
        {/* <Text color="#808080" fontSize="13px" mb="7px">
            Masukkan tanggal dan waktu sebagai ajuan perbaikan.
          </Text> */}
        <Flex w="100%">
          {" "}
          <Input
