...
interface FoundationCardInterface extends CardProps {
  title: string;
  description: string;
  image?: string;
    ...
    <>
      ...
      >
        <Link as={NextLink} href={url} _hover={{ textDecor: "none" }}>
          <Box
            bgImage='url("/images/app/foundations/foundbg.png")'
            pos="relative"
            bgSize="cover"
            bgPosition="center"
            bgRepeat="no-repeat"
          ...
          >
            <Box
              bgImage='url("/images/app/foundations/foundcover.png")'
              pos="absolute"
              bgSize="cover"
              bgPosition="center"
              bgRepeat="no-repeat"
