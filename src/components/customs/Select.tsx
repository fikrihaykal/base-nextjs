...
import { useColorMode, useTheme, Text } from "@chakra-ui/react";
...
const DropdownSelect: React.FC<SelectProps> = ({
  ...
  const customStyles: StylesConfig = {
    control: (base, props): CSSObjectWithLabel => {
      return {
        ...base,
    ...
    input: (base, state): CSSObjectWithLabel => {
      return {
        ...base,
        fontSize: "14px",
        fontWeight: 500,
    ...
    valueContainer: (base, state): CSSObjectWithLabel => {
      return {
        ...base,
        padding: "0px",
      } as CSSObjectWithLabel;
