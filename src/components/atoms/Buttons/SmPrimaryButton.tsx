...
const SmPrimaryButton = ({ children, ...btnProps }: PrimaryButtonInterface) => {
...
const SmPrimaryButtonDanger = ({ children, ...btnProps }: PrimaryButtonInterface) => {
  const { colorMode } = useColorMode();
  return (
    <>
      <Button
...
export { SmPrimaryButton, SmPrimaryButtonDanger };
